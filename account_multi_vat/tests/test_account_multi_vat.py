...
class TestAccountMultiVat(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.vat_partner_lu = cls.partner_model.create(
            {"name": "LU Tax Administration", "is_tax_administration": True}
        )
        cls.vat_partner_be = cls.partner_model.create(
            {"name": "BE Tax Administration", "is_tax_administration": True}
        )
    ...
    def test_01(self):
        ...
        """
        self.assertFalse(self.partner_01.is_multi_vat)
    ...
    def test_02(self):
        ...
        Expected result:
            ...
            - is_multi_vat is True on the partner
        """
        self.partner_01.id_numbers = [
            (
                0,
        ...
        self.assertTrue(self.partner_01.is_multi_vat)
    ...
    def test_05(self):
        ...
        Expected result:
            ...
            - is_multi_vat is False on the partner
        """
        self.partner_01.id_numbers = [
            (
                0,
